...
public class Constants {
    ...
    public static final String ENTERPRISE_WE_CHAT_GROUP_ROBOT_URL = "enterprise.wechat.group.robot.url";

    public static final String ENTERPRISE_WE_CHAT_GROUP_SEND_MSG = "enterprise.wechat.group.send.msg";
